...
**Privacy policy:** [/privacy](https://replyly-kappa.vercel.app/privacy) (`privacy.html`)

## Publishing to App Store / Play Store

- **Web / PWA (this folder):** installable via Add to Home Screen — free, already live.
- **Native Expo app:** see sibling folder [`../replyly-mobile/`](../replyly-mobile/) and [`STORE_LAUNCH.md`](../replyly-mobile/STORE_LAUNCH.md) for EAS builds, bundle IDs, and store checklists.
...
Until developer accounts are ready, **Add to Home Screen** remains the free mobile install path.
